            ...
            <TabsList className="flex h-auto w-full flex-wrap items-center justify-start gap-2 bg-transparent p-0">
                {tabs.map((tab) => (
                    <TabsTrigger
                        ...
                        value={tab.value}
                        className={cn(
                            "flex items-center gap-2 rounded-full border px-4 py-2 text-xs font-black uppercase tracking-widest transition-all data-[state=active]:border-transparent data-[state=active]:text-white shadow-sm",
